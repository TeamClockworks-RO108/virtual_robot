...
public class ArmBot extends TwoWheelPhysicsBase {
    ...
    public void initialize(){
        ...
        armMotor.setActualPositionLimits(0, 383.6 * 2);
    ...
    protected void createHardwareMap() {
        ...
        hardwareMap.put("arm_motor", new DcMotorExImpl(MotorType.Gobilda137, motorController1, 0));
    ...
    public synchronized void updateStateAndSensors(double millis){
        ...
        armTranslation = armMotor.getActualPosition() * 50.0 / (383.6 * 2) * (botWidth / 75.0);
